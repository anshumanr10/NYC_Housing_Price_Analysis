...
#meter data overview
print("=== METER DATA OVERVIEW ===")

#add the meter data together
...
fig1, ax1 = create_wind_rose(weather['wind_speed_100m'], 
                             weather['wind_direction_100m'],
                             title='Wind Rose - Entire Dataset')
plt.show()
